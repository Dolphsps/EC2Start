    ...
    ec2.describeInstances(param, function (err, data) {
        if (err) {
            ...
            if (ccount > 0) {
                ...
                if (ccount == 1) {
                    console.log("1 instance will be started");
                } else {
                    console.log(ccount + " instances will be started");
                }
                ec2.startInstances(params1, function (err, data1) {
                ...
                console.log("No instances to be started");
            }
